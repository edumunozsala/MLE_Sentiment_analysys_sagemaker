...
class LSTMClassifier(nn.Module):
    ...
    def __init__(self, embedding_dim, hidden_dim, vocab_size):
        ...
        ### UPDATED ###
        # Use a GRU unit and added a n_layers and dropout parameters
        ...
        self.lstm = nn.GRU(embedding_dim, hidden_dim, num_layers=2, bidirectional=True)
        # Because of the bidirectional option we need to double the input dim
